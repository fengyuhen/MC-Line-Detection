...
def mydeeplab3(shape):
    ...
    input_nor = Lambda(lambda x: x/255.)(input_img)
...
if __name__ == '__main__':
    print("********** load labels **********")
    train_labels = np.load('/home/mc16/pre_data/train_2w_label_w3.npy')
    val_labels = np.load('/home/mc16/pre_data/val_label_w3.npy')
    
    print("********** load images **********")
    train_images = np.load('/home/mc16/pre_data/train_2w_image.npy')
    ...
    parallel_deeplab3 = multi_gpu_model(deeplab3, gpus=6)
